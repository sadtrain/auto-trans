...
@Component
public class JDGoodsConvertor {

    private static Logger logger = LoggerFactory.getLogger(JDGoodsConvertor.class);
...
//        ResponseEntity<DtkTwdToTwdResponse> forEntity = restTemplate.getForEntity(host, DtkTwdToTwdResponse.class, paraMap);
    ...
    public static void main(String[] args) {
        JDGoodsConvertor convertor = new JDGoodsConvertor();
        String str = "\n" +
